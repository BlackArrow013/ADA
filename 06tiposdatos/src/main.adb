...
begin
   ...
   --  Peras := 2;
   --  Manzanas := 4;
   --  --Peras := Manzanas; --En cualquier lenguaje esto es una asignación válida, excepto en ADA.
   --  Frutas := Peras + Manzanas;
   --  Put_Line("En total tengo" & Frutas'Image & " frutas");
   --
   --
   --  Frutas := 300;
   --  Frutas := Frutas + 50; --Falla en tiempo de ejecución si el rango es 0..300;
   ...
   --     Base := 10.0;
   --     Altura := 30.0;
   --     --Superficie := Base * Altura; --Asignación no compatible.
